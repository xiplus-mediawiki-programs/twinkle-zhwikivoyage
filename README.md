...
[MediaWiki:Gadgets-definition][]应当包含这一行：
    ...
    * Twinkle[ResourceLoader|dependencies=mediawiki.user,mediawiki.util,mediawiki.RegExp,jquery.ui.dialog,jquery.tipsy,moment|rights=autoconfirmed]|morebits.js|morebits.css|Twinkle.js|friendlytag.js|friendlytalkback.js|friendlywelcome.js|twinkleclose.js|twinkleconfig.js|twinklecopyvio.js|twinklediff.js|twinklefluff.js|twinklespeedy.js|twinkleunlink.js|twinklexfd.js
